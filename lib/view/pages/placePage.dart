                ...
                children: [
                  Padding(
                    padding: EdgeInsets.symmetric(
                        horizontal: dSpace_12, vertical: dSpace_8),
                    child: const PlaceAppBar(),
                  ),
                  Padding(
                    padding: EdgeInsets.only(bottom: dSpace_12),
                    child: const TopCard(
                        txtPlace: "The Oasis Lagoon Sanr",
                        txtDitance: "21 miles",
                        txtPoint: "4.8"),
                  ),
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: dSpace_12),
                    child: const AboutText(txtAbout: txt_About),
                  ),
                  SizedBox(
                    height: dSpace_16 + dSpace_8,
                  ),
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: dSpace_12),
